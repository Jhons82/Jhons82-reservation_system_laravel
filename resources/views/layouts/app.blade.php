...
<head>
    ...
    <meta charset="utf-8" />
    <title>J-GOD | Dashboard - Reservas</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Sistema de Reservaciones de J-GOD" name="description" />
...
<body>
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
        ...
        <div class="offcanvas-body p-0">
            <div data-simplebar class="h-100">
                <div class="p-4">
                    ...
                    <p class="text-muted">Elige tu tema.</p>
                    ...
                    <div id="layout-width">
                        ...
                        <p class="text-muted">Elija entre diseño fluido o en caja.</p>
                    ...
                    <div id="layout-position">
                        <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Posición del diseño</h6>
                        <p class="text-muted">Elija entre posición de diseño fija o desplazable.</p>

                        <div class="btn-group radio" role="group">
                            <input type="radio" class="btn-check" name="data-layout-position" id="layout-position-fixed" value="fixed">
                            <label class="btn btn-light w-sm" for="layout-position-fixed">Fijado</label>
                    ...
                    <p class="text-muted">Elija el color claro u oscuro de la barra superior.</p>
                    ...
                    <div id="sidebar-size">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <h5 class="fs-13 text-center mt-2">Vista pequeña al pasar el mouse</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="sidebar-img">
                        <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Imágenes de la barra lateral</h6>
                        <p class="text-muted">Elija una imagen de la barra lateral.</p>
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                <div class="col-12">
                    <button type="button" class="btn btn-light w-100" id="reset-layout">Reiniciar</button>
                </div>
            </div>
        </div>
    </div>
